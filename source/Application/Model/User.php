...
class User extends \OxidEsales\Eshop\Core\Model\BaseModel
{
    ...
    public function delete($sOXID = null)
    {
        ...
        if ($blDeleted) {
            ...
            $this->deleteAddresses($database, $quotedUserId);
            $this->deleteUserFromGroups($database, $quotedUserId);
            $this->deleteBasket($database, $quotedUserId);
            $this->deleteNewsletterSubscriptions($database, $quotedUserId);
            $this->deleteDeliveries($database, $quotedUserId);
            $this->deleteDiscounts($database, $quotedUserId);
            $this->deleteRecommendationLists($database, $quotedUserId);

            $this->deleteAdditionally($quotedUserId);

            $this->deleteNotOrderRelatedRemarks($database, $quotedUserId);
        }
     ...
     * @param int               $userId
     */
    private function deleteNotOrderRelatedRemarks(DatabaseInterface $database, $userId)
    {
        $database->execute("delete from oxremark where oxparentid = {$userId} and oxtype !='o'");
    }
     ...
     * @param int               $userId
     */
    private function deleteAddresses(DatabaseInterface $database, $userId)
    {
        $database->execute("delete from oxaddress where oxaddress.oxuserid = {$userId}");
    }
     ...
     * @param int               $userId
     */
    private function deleteUserFromGroups(DatabaseInterface $database, $userId)
    {
        $database->execute("delete from oxobject2group where oxobject2group.oxobjectid = {$userId}");
    }
     ...
     * @param int               $userId
     */
    private function deleteDeliveries(DatabaseInterface $database, $userId)
    {
        $database->execute("delete from oxobject2delivery where oxobjectid = {$userId}");
    }
     ...
     * @param int               $userId
     */
    private function deleteNewsletterSubscriptions(DatabaseInterface $database, $userId)
    {
        $database->execute("delete from oxnewssubscribed where oxuserid = {$userId}");
    }
     ...
     * @param int               $userId
     */
    private function deleteDiscounts(DatabaseInterface $database, $userId)
    {
        $database->execute("delete from oxobject2discount where oxobjectid = {$userId}");
    }
     ...
     * @param int               $userId
     */
    private function deleteBasket(DatabaseInterface $database, $userId)
    {
        $database->execute("
            delete 
                oxuserbasketitems.* 
        ...
        $database->execute("delete from oxuserbaskets where oxuserid = {$userId}");
    }
     ...
     * @param int               $userId
     */
    private function deleteRecommendationLists(DatabaseInterface $database, $userId)
    {
        $database->execute("
            delete oxobject2list
            ...
            where 
                oxrecommlists.oxuserid = {$userId}
        ");

        $database->execute("delete from oxrecommlists where oxuserid = {$userId}");
    }
}
